//! OBS-1 / OBS-2 well-formedness: drive the REAL reticulum-core transport emit
...
use reticulum_core::constants::{MTU, RANDOM_HASHBYTES, TRUNCATED_HASHBYTES};
use reticulum_core::packet::{
    HeaderType, Packet, PacketContext, PacketData, PacketFlags, PacketType, TransportType,
};
use reticulum_core::transport::{Transport, TransportConfig};
use reticulum_core::{Clock, Destination, DestinationType, Direction, Identity, MemoryStorage};
