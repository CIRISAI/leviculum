...
/// dependency on the host runtime's time driver. That dependency was #58 —
...
mod tests {
    ...
    /// Regression for #58: `spawn_traffic_counter` must not panic when the
    /// host runtime lacks a time driver.
    ///
    ...
    fn spawn_traffic_counter_survives_runtime_without_time_driver() {
        ...
        // that surfaced #58. (`#[tokio::test]` would enable_all and hide it.)
        ...
        assert_eq!(
            ...
            0,
            "spawn_traffic_counter panicked under a runtime without the time driver (#58)"
        );
    }
