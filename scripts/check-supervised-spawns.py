...
# `strip_noise` and `receiver_words` were defined here until #199 needed the
# same two functions for scripts/check-core-lock-census.py. One copy.
from rust_source import IDENT, line_of, receiver_words, strip_noise  # noqa: E402
