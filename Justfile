...
lint-nrf:
    ...
    # leviculum-screen, leviculum-sd-policy and leviculum-gnss-time are the
    ...
    # thumbv7em).
    cd leviculum-nrf && cargo clippy -p leviculum-screen -p leviculum-sd-policy -p leviculum-gnss-time --target $(rustc -vV | sed -n 's/host: //p') -- -D warnings
    cd leviculum-nrf && cargo test -p leviculum-screen -p leviculum-sd-policy -p leviculum-gnss-time --target $(rustc -vV | sed -n 's/host: //p')
