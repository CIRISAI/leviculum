...
mod tests {
    ...
    fn kat_token_python_rns_vector() {
        ...
        let plaintext: [u8; 20] = [
            0x52, 0x65, 0x74, 0x69, 0x63, 0x75, 0x6c, 0x75, 0x6d, 0x20, 0x4b, 0x41,
            0x54, 0x20, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72,
        ];
        // Reference token from Python-RNS: IV(16) || ciphertext(32) || HMAC(32) = 80 bytes
        let reference_token: [u8; 80] = [
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
            0x0c, 0x0d, 0x0e, 0x0f, 0xc4, 0x82, 0xfe, 0x75, 0xc9, 0xe6, 0xe5, 0x17,
            0x27, 0xf3, 0xed, 0x90, 0xbe, 0xcc, 0xa8, 0x28, 0x2a, 0x48, 0xcf, 0x0a,
            0xd1, 0x18, 0xa8, 0x4d, 0xd9, 0xd0, 0xe9, 0xbe, 0xb3, 0xe3, 0x11, 0xfa,
            0x09, 0xca, 0x0e, 0xa1, 0x8e, 0x52, 0x46, 0x1d, 0xde, 0x6f, 0xee, 0x12,
            0xfb, 0x0f, 0x05, 0x58, 0x59, 0xc0, 0xb2, 0xc8, 0x33, 0x87, 0x36, 0x75,
            0x45, 0x24, 0x07, 0x77, 0x0f, 0xb5, 0xd3, 0xa7,
        ];
