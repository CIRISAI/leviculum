...
(`leviculum-nrf/Cargo.toml:319-329`)
...
therefore `cd leviculum-nrf` before invoking cargo. (`Justfile:1318-1319`)
...
automatically. (`Justfile:1345-1347`, `Justfile:1385-1394`. See
...
(`Justfile:1320-1322`; rationale `leviculum-nrf/README.md:25`)
...
(`Justfile:1329-1334`; usage forms `leviculum-nrf/README.md:31-36`)
...
(`Justfile:1358-1364`; `rak-baseboard` aggregate
