...
therefore `cd leviculum-nrf` before invoking cargo. (`Justfile:1228-1229`)
...
automatically. (`Justfile:1255-1257`, `Justfile:1295-1304`. See
...
(`Justfile:1230-1232`; rationale `leviculum-nrf/README.md:25`)
...
(`Justfile:1239-1244`; usage forms `leviculum-nrf/README.md:31-36`)
...
(`Justfile:1268-1274`; `rak-baseboard` aggregate
