...
therefore `cd leviculum-nrf` before invoking cargo. (`Justfile:1271-1272`)
...
automatically. (`Justfile:1298-1300`, `Justfile:1338-1347`. See
...
(`Justfile:1273-1275`; rationale `leviculum-nrf/README.md:25`)
...
(`Justfile:1282-1287`; usage forms `leviculum-nrf/README.md:31-36`)
...
(`Justfile:1311-1317`; `rak-baseboard` aggregate
