...
therefore `cd leviculum-nrf` before invoking cargo. (`Justfile:1455-1456`)
...
automatically. (`Justfile:1482-1484`, `Justfile:1522-1531`. See
...
(`Justfile:1457-1459`; rationale `leviculum-nrf/README.md:25`)
...
(`Justfile:1466-1471`; usage forms `leviculum-nrf/README.md:31-36`)
...
(`Justfile:1495-1501`; `rak-baseboard` aggregate
