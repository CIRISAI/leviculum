...
(`leviculum-nrf/Cargo.toml:324-334`)
...
therefore `cd leviculum-nrf` before invoking cargo. (`Justfile:1341-1342`)
...
automatically. (`Justfile:1368-1370`, `Justfile:1408-1417`. See
...
(`Justfile:1343-1345`; rationale `leviculum-nrf/README.md:25`)
...
(`Justfile:1352-1357`; usage forms `leviculum-nrf/README.md:31-36`)
...
(`Justfile:1381-1387`; `rak-baseboard` aggregate
`leviculum-nrf/Cargo.toml:314`)
