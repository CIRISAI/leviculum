...
`Transport::emission_secs` (`leviculum-core/src/transport.rs:2561`)
...
`Node::set_wall_time_unix_secs` (`leviculum-core/src/node/mod.rs:677`
...
(`transport.rs:2649`) adopts the highest emission timestamp seen in
