...
`leviculum-nrf/src/bin/t114.rs:966`;
`handle_interface_peer_lost`, `leviculum-nrf/src/bin/t114.rs:994`;
`handle_interface_peer_up`, `leviculum-nrf/src/bin/t114.rs:1006`; the
same three in `handle_packet_from_peer`,
`leviculum-nrf/src/bin/rak4631.rs:946`), the core stamps the peer onto
