...
`leviculum-nrf/src/bin/t114.rs:969`;
`handle_interface_peer_lost`, `leviculum-nrf/src/bin/t114.rs:997`;
`handle_interface_peer_up`, `leviculum-nrf/src/bin/t114.rs:1009`; the
same three in `handle_packet_from_peer`,
`leviculum-nrf/src/bin/rak4631.rs:949`), the core stamps the peer onto
