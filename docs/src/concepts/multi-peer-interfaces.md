...
(`registry`, `leviculum-std/src/driver/mod.rs:4375`).
...
(`leviculum-std/src/driver/mod.rs:4148`) to cull the routing entries,
...
leaves (`remove_spawned`, `leviculum-std/src/driver/mod.rs:3730`).
