...
`leviculum-core/src/transport.rs:4241`). So the identity-shaped
...
(`interface_announce_caps`, `leviculum-core/src/transport.rs:1955`
through `own_tunnel_ids`,
`leviculum-core/src/transport.rs:2195` — the `BTreeMap<usize, _>` and
...
(`interface_held_announces`, `leviculum-core/src/transport.rs:2099`, is
...
(`interface_names`, `leviculum-core/src/transport.rs:10139`), each
...
| Announce cap and egress slot (`interface_announce_caps`, `leviculum-core/src/transport.rs:1955`; `interface_next_slot_ms`, `leviculum-core/src/transport.rs:2136`) | **medium** — it rations a shared resource | parent (splitting it per link multiplies the budget by the link count) |
| Max-airtime backchannel (`interface_max_airtime_ms`, `leviculum-core/src/transport.rs:2144`) | **medium** | parent |
