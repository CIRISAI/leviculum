...
`leviculum-nrf/src/bin/t114.rs:867`;
`handle_interface_peer_lost`, `leviculum-nrf/src/bin/t114.rs:894`;
`handle_interface_peer_up`, `leviculum-nrf/src/bin/t114.rs:906`; the
...
(`note_strict_reset`, `leviculum-nrf/src/ble/columba.rs:1013`); a dial
that timed out records at most a dead end and leaves the clock running
(`note_dead_end`, `leviculum-nrf/src/ble/columba.rs:1417`).
