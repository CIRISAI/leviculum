...
queued message to `Outbound` (`leviculum-lxmf/src/router.rs:1926-1929`). So
...
(`leviculum-core/src/rnode.rs:909`) and `packet_airtime_ms`
(`leviculum-core/src/rnode.rs:1356`) are public, interfaces report a
`bitrate` (`leviculum-std/src/interfaces/mod.rs:464-466`) computed from
spreading factor, coding rate and bandwidth
(`compute_bitrate`, `leviculum-std/src/interfaces/rnode.rs:1443`), and
