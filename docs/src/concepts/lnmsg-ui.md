...
queued message to `Outbound` (`leviculum-lxmf/src/router.rs:1863-1866`). So
...
(`leviculum-core/src/rnode.rs:809`) and `packet_airtime_ms`
(`leviculum-core/src/rnode.rs:1141`) are public, interfaces report a
