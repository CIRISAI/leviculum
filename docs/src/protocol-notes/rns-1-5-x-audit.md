...
(`transport.rs:8494`, `:10539`) or our own locally-created announces (`:10210`) — neither is a
...
test on a carried transport id is against our OWN hash (`transport.rs:2965`), to decide whether a
